...
void Tracking_data_client_udp_transfer::init()
{
    //------------------------------------------------------------
    // Parse Arguments
    ...
    bufferPKT = new unsigned char[RTP_PAYLOAD_LENGTH + RTP_HEADER_LENGTH];
    rtpWrapper = igtl::MessageRTPWrapper::New();
    glock = igtl::SimpleMutexLock::New();
}

void Tracking_data_client_udp_transfer::loop()
{
...
int Tracking_data_client_udp_transfer::ReceiveTrackingData(igtl::TrackingDataMessage::Pointer& msgData)
{
